...
def visualize_saved_in_server(our_approach=True, small=True, n_gates=1, how_many=1, gamma=1, flat=False):
    ...
    if flat:
        ...
        visualize_policy_params(parameter_dataset, parameter_dataset2=None, small=small, how_many=how_many)
        ...
        visualize_ship_steering(dataset_eval, 'evaluate', small=small, n_gates=n_gates, how_many=how_many)
        visualize_control_block(datalist_control=low_level_dataset, ep_count=2, how_many=how_many)
